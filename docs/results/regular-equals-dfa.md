...
- [`isRegular_of_is_RG`](https://github.com/nielstron/langlib/blob/main/src/Langlib/Automata/FiniteState/Equivalence/Regular.lean) — every regular-grammar language is regular (Mathlib `IsRegular`/DFA).
- [`is_RG_of_isRegular`](https://github.com/nielstron/langlib/blob/main/src/Langlib/Automata/FiniteState/Equivalence/Regular.lean) — every DFA language is generated by a regular grammar.
