          ...
          have almost : z = List.repeat a i ++ [a, S, c] ++ List.repeat c i,
          {
            ...
            have u_must : u = List.repeat a i,
            {
              ...
              cases @trichotomous ℕ (<) _ (List.length u) i with hlt hge,
              {
                ...
                have please : (List.repeat a i).nthLe u.length hlt = S,
                {
                  rw List.nthLe_nth hlt at indexS,
                  injection indexS,
                },
                rw List.nthLe_repeat a hlt at please,
                injection please,
              },
              cases hge.symm with hgt heq,
              {
                ...
                rw List.nthLe_nth rightend at indexS,
                ...
                rw List.nthLe_append_right mala at continue,
                finish,
              },
              rw List.append_assoc at the_case,
        ...
        any_goals { try { cases rule_in },
          ...
          have u_eq : u = List.repeat a i ++ List.repeat b j,
          {
            cases @trichotomous ℕ (<) _ u.length (i + j) with hlt rest,
            {
              ...
              have propos : (List.repeat a i ++ List.repeat b j).nthLe u.length h_len = R,
              {
                ...
                rw List.nthLe_nth h_len at indexR,
                injection indexR,
              },
              have yes_R : R ∈ (List.repeat a i ++ List.repeat b j),
              {
                let positive := List.nthLe_mem (List.repeat a i ++ List.repeat b j) u.length h_len,
            ...
            cases rest.symm with hgt heq,
            {
              ...
              have yes_Rc : R ∈ List.repeat c (i + j),
              {
                ...
                rw List.nth_append_right at indexR,
                {
                  ...
                  rw List.nthLe_nth trouble_len at indexR,
                  {
                    finish,
                  },
                },
