...
lemma mem_computeRules_left {n : g.NT} {r : ContextFreeRule T g.NT} {r' : ChomskyNormalFormRule T g.NT'}
...
lemma restrictLength_derives_derives_projectString {u v : List (Symbol T g.NT')} [DecidableEq T] [DecidableEq g.NT]
